...
frailty_data = read.csv("C:\\Users\\sailo\\OneDrive\\Documents\\Assignment\\1\\data_raw\\raw_frailty_data1.csv")
...
write.csv(frailty_data, "C:\\Users\\sailo\\OneDrive\\Documents\\Assignment\\1\\data_clean\\clean_frailty_data.csv")
