...
Student = read.csv("C:\\Users\\sailo\\OneDrive\\Documents\\Assignment\\2\\data_raw\\StudentsPerformance.csv")
Student
...
#save the clean Data
write.csv(Student_Data, "C:\\Users\\sailo\\OneDrive\\Documents\\Assignment\\2\\data_clean\\clean_StudentsData.csv")
